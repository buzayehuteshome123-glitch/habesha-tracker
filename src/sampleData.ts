...
export const TRANSLATIONS = {
  en: {
    ...
    todayProfit: "Today's Sales Profit",
    todaySalesProfit: "Today's Sales Profit",
    todayNetProfit: "Today's Net Profit",
    todaySales: "Today's Sales",
    bankExpensesNote: "Bank expenses are deducted from Bank Balance without reducing daily sales profit",
    cashExpensesLabel: "Cash Expenses",
    bankExpensesLabel: "Bank Paid",
  ...
  am: {
    ...
    todayProfit: 'የዛሬ የሽያጭ ትርፍ',
    todaySalesProfit: 'የዛሬ የሽያጭ ትርፍ',
    todayNetProfit: 'የዛሬ የተጣራ ትርፍ',
    todaySales: 'የዛሬ ጠቅላላ ሽያጭ',
    bankExpensesNote: 'የባንክ ወጪዎች ከባንክ ሂሳብ ብቻ የሚቀነሱ ሲሆን የዕለቱን የሽያጭ ትርፍ አይቀንሱም',
    cashExpensesLabel: 'የጥሬ ገንዘብ ወጪ',
    bankExpensesLabel: 'በባንክ የተከፈለ',
